...
<c:set var="TotalPrice" value="${TotalPrice + (product.value.quantityAcheter * product.value.price)}" scope="page"/>
 <!-- SHIPPING METHOD -->
    ...
    <p id="title-p-d">Choose a Shipping Method</p>
     ...
     <!-- end checkout step -->
  	...
  	<div class="row" id="cart-row">
        ...
        <p class="small">Quantity: <span class="pull-right">${product.value.quantityAcheter} x ${product.value.getPrice()}</span></p>
        <p class="small">Total: <span class="pull-right">${product.value.quantityAcheter*product.value.getPrice()}</span></p>
			</div>
		</div>
</c:forEach>
  <hr>
